...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.description': 'Professional drone spraying services powered by cutting-edge DJI technology. Maximize your crop yield with precision aerial application.',
    ...
    'services.description': 'Leveraging the power of DJI Agras T50 to deliver precise, efficient, and cost-effective agricultural services.',
    'services.spraying.title': 'Precision Spraying',
    'services.spraying.description': '40kg capacity with 24L/min flow rate for efficient, targeted application of pesticides and fertilizers.',
    'services.fertilization.title': 'Crop Fertilization',
    'services.fertilization.description': '50kg spreading capacity ensures even distribution of granular fertilizers and seeds up to 5mm across your fields.',
    'services.mapping.title': 'Field Mapping',
    'services.mapping.description': 'Advanced terrain mapping and route planning for optimized coverage of irregularly shaped fields.',
    'services.pest.title': 'Pest Control',
    'services.pest.description': 'Rapid response aerial pest treatment to protect your crops before infestations spread.',
    ...
    'services.greenhouse.description': 'Specialized shading application for greenhouses to regulate temperature and light.',
    
    // Features
    'features.badge': 'DJI Agras T50',
    'features.title1': 'Industry-Leading',
    'features.title2': 'Technology',
    'features.description': 'The DJI Agras T50 represents the pinnacle of agricultural drone technology. With its coaxial twin-rotor propulsion and split-type torque resistant structure, it delivers unmatched stability and performance.',
    ...
    'benefits.subtitle': 'Fast, efficient, economical, and safe way to reduce consumption and increase your production.',
    ...
    'video.description': 'Watch how our DJI Agras T50 drone efficiently covers fields with precision spraying technology.',
    
    // Contact
    'contact.badge': 'Contact Us',
    'contact.title1': 'Ready to Transform',
    'contact.title2': 'Your Operations?',
    'contact.description': 'Get in touch for a free consultation and quote. We\'ll assess your needs and provide a tailored solution for your agricultural operations.',
  ...
  bg: {
    ...
    'hero.description': 'Професионални услуги за пръскане с дрон, задвижвани от най-съвременната технология на DJI. Максимизирайте добива си с прецизно аерозолно приложение.',
    ...
    'services.description': 'Използваме силата на DJI Agras T50 за доставяне на прецизни, ефективни и рентабилни земеделски услуги.',
    'services.spraying.title': 'Прецизно Пръскане',
    'services.spraying.description': '40kg капацитет с 24L/min дебит за ефективно, целево приложение на пестициди и торове.',
    'services.fertilization.title': 'Торене на Култури',
    'services.fertilization.description': '50kg капацитет за разпръскване осигурява равномерно разпределение на гранулирани торове и семена до 5мм.',
    'services.mapping.title': 'Картографиране',
    'services.mapping.description': 'Усъвършенствано картографиране на терена и планиране на маршрути за оптимално покритие.',
    ...
    'services.herbicide.description': 'Прецизно приложение на хербициди за контрол на плевелите без да се увреждат културите.',
    'services.greenhouse.title': 'Засенчване на Оранжерии',
    'services.greenhouse.description': 'Специализирано засенчване за оранжерии за регулиране на температурата и светлината.',
    
    // Features
    'features.badge': 'DJI Agras T50',
    'features.title1': 'Водеща в Индустрията',
    'features.title2': 'Технология',
    'features.description': 'DJI Agras T50 представлява върха на земеделската дрон технология. С коаксиална двуроторна система и устойчива на въртящ момент конструкция, осигурява несравнима стабилност.',
    ...
    'benefits.subtitle': 'Бърз, ефективен, икономичен и безопасен начин да намалите потреблението и да увеличите производството си.',
    ...
    'video.description': 'Гледайте как нашият DJI Agras T50 дрон ефективно покрива полетата с прецизна технология за пръскане.',
    
    // Contact
    'contact.badge': 'Свържете се с Нас',
    'contact.title1': 'Готови ли сте да Трансформирате',
    'contact.title2': 'Вашите Операции?',
    'contact.description': 'Свържете се с нас за безплатна консултация и оферта. Ще оценим нуждите ви и ще предоставим персонализирано решение.',
