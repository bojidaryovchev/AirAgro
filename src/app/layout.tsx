...
export const metadata: Metadata = {
  ...
  description:
    "Професионално пръскане, засяване и торене с агро дрон в цяла България. DJI Agras T50 с RTK прецизност. Спестете 30% препарати. Над 25,000 дка опит. ☎ 0876-543-546",
  keywords: [
    "пръскане с дрон",
    "агро дрон",
    "земеделски дрон",
  ...
  openGraph: {
    ...
    description:
      "Професионално пръскане с агро дрон в цяла България. DJI Agras T50 с RTK прецизност. Спестете 30% препарати. Над 25,000 дка опит. Обадете се: 0876-543-546",
    images: [
      {
